# Example of a prediction rule ensemble (pre) for predicting depression
...
```{r}
carpre <- pre(bdi ~ ., data = cardata[train,])
...
legend("topleft", c("observed", "bs null model mean"), bty = "n", col = c("yellow", "blue"), pch = 15)
